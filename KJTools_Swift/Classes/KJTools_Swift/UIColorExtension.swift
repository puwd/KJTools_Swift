...
extension UIColor {
    ...
    /// 自定义颜色
    class func KRGBA(WithRed red:CGFloat = 0, green:CGFloat = 0, blue:CGFloat = 0, alpha:CGFloat = 1.0) -> UIColor
    {
    ...
    /// 十六进制颜色
    class func color(WithHex hex:UInt32 , alpha:CGFloat = 1.0) -> UIColor {
